...
function updateReelsUI() {
    ...
    var pos = Math.min(progress, 1) * (window.innerHeight - 60);
    $(".marker").css({"transform": "translate(0, " + pos + "px)"});
    $(".marker").css({"display": "block"});
    $(".marker span").text("Reel " + reelsWatched);
}

function loadRocks() {
    var rockCount = 10;
    if (cpuSetting === 'low') rockCount = 3;
    if (cpuSetting === 'none') rockCount = 0;

    for(var i = 1; i <= rockCount; i++){
        var rockPos = depthStart + (Math.random() * (depthBottomPixel - depthStart));
        var rockLeft = (Math.random() * 100) - 10;
        var rockScale = 0.5 + Math.random();
        var rockOpacity = 0.2 + (Math.random() * 0.4);
        var rockRotate = Math.random() * 360;
        
        var rockHtml = '<div class="creature--wrapper" style="transform: translate(' + rockLeft + 'vw, ' + rockPos + 'px) scale(' + rockScale + ') rotate(' + rockRotate + 'deg); opacity: ' + rockOpacity + '"><svg width="200px" height="100px" viewBox="0 0 1333 291" version="1.1" xmlns="http://www.w3.org/2000/svg"><g fill="#D8D8D8"><path d="M34,937.037871 L102.36719,782.763552 L195.974042,782.763552 L262.011649,859.900712 L396.492082,907.191989 L396.492082,949.404322 L262.011649,995.171538 L34,982.517914 L34,937.037871 Z M1216.41445,817.476134 L1136.52101,875.733964 L1089.01915,848.308754 L1078.10749,789.816737 L1023.71941,726.417772 L1036.0869,704.996645 L1117.73953,721.172024 L1229.73933,794.396771 L1216.41445,817.476134 Z M837.058065,952.238533 L982.51325,858.382082 L1132.35531,905.310308 L1132.35531,983.688137 L837.058065,952.238533 Z M549,861.613678 L698.562209,810 L782.472553,862.707043 L782.472553,981.125972 L634.21128,995.171538 L549,940.751588 L549,861.613678 Z M834.207142,798.121399 L915.213072,719.153854 L972.273831,758.637627 L972.273831,830.188964 L875.829517,858.382082 L817,830.188964 L834.207142,798.121399 Z M434.090409,903.686877 L387.590849,800.557712 L444.209388,760.442383 L511.445651,784.914382 L504.952619,885.185007 L458.338873,930.824055 L434.090409,903.686877 Z M1276.35036,837.894431 L1367.0178,905.549797 L1336.94641,968.084667 L1266.27598,979.277762 L1223.34276,888.431213 L1241.98581,825.91561 L1276.35036,837.894431 Z"></path></g></svg></div>';
        $(".creatures").append(rockHtml);
    }
}
